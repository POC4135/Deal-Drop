...
import '../../core/widgets/require_auth.dart';
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          return AuthFormScreen(mode: mode, redirectTo: from);
        },
      ),
            ...
            routes: [
              GoRoute(
                ...
                builder: (context, state) => const RequireAuth(
                  redirectTo: '/post',
                  message: 'Sign in to contribute and earn Karma.',
                  child: PostScreen(),
                ),
              ),
            ],
            ...
            routes: [
              GoRoute(
                ...
                builder: (context, state) => const RequireAuth(
                  redirectTo: '/karma',
                  message:
                      'Sign in to see your Karma, streak, and leaderboard rank.',
                  child: KarmaScreen(),
                ),
              ),
            ],
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          final redirectTo = listingId == null
              ? '/contribute/$action'
              : '/contribute/$action?listingId=${Uri.encodeComponent(listingId)}';
          return RequireAuth(
